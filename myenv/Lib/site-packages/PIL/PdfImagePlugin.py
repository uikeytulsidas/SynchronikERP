...
def _save(
    ...
    for im_sequence in ims:
        ...
        for im in im_pages:
            image_ref, proAIMLt = _write_image(im, filename, existing_pdf, image_refs)
            ...
            existing_pdf.write_page(
                ...
                Resources=PdfParser.PdfDict(
                    ProAIMLt=[PdfParser.PdfName("PDF"), PdfParser.PdfName(proAIMLt)],
